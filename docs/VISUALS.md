...
![Average Damage by Eidolon](../output/avg_damage_by_eidolon.png)
...
In the example above, notice how E6 provides a substantial jump in damage compared to earlier Eidolons.

### 2. Damage per Pull Efficiency

![Damage per Pull Efficiency](../output/damage_per_pull.png)
...
![Marginal Value of Each Eidolon](../output/marginal_value.png)
